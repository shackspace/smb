...
CREATE
  TABLE account
  (
    acco_id             NUMERIC (31) NOT NULL ,
    acco_name           VARCHAR (255) ,
    acco_create_date    DATE ,
    acco_create_user_id NUMERIC (31)
  ) ;
...
CREATE
  TABLE currency
  (
    curr_id             NUMERIC (31) NOT NULL ,
    curr_name           VARCHAR (2000) NOT NULL ,
    curr_create_date    DATE ,
    curr_create_user_id NUMERIC (31) NOT NULL
  ) ;
...
CREATE
  TABLE "transaction"
  (
    tran_id             NUMERIC (31) NOT NULL ,
    tran_acco_id_src    NUMERIC (31) NOT NULL ,
    tran_acco_id_dest   NUMERIC (31) NOT NULL ,
    tran_amount         NUMERIC (31) NOT NULL ,
    tran_description    VARCHAR (2000) ,
    tran_curr_id        NUMERIC (31) NOT NULL ,
    tran_create_date    DATE ,
    tran_create_user_id NUMERIC (31)
  ) ;
...
CREATE
  ...
  (
    trre_id             NUMERIC (31) NOT NULL ,
    trre_tran_id_src    NUMERIC (31) NOT NULL ,
    trre_tran_id_dest   NUMERIC (31) NOT NULL ,
    trre_create_date    DATE ,
    trre_create_user_id NUMERIC (31) NOT NULL
  ) ;
...
CREATE
  TABLE user_account
  (
    usac_id             NUMERIC (31) NOT NULL ,
    usac_user_id        NUMERIC (31) NOT NULL ,
    usac_acco_id        NUMERIC (31) NOT NULL ,
    usac_create_date    DATE ,
    usac_create_user_id NUMERIC (31)
  ) ;
